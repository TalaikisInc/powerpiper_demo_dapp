describe('Add user', function () {
  it('.should() - assert that <title> is correct', function () {
    cy.visit(`https://${process.env.HOST}:${process.env.PORT}`)
    cy.title().should('include', 'PowerPiper')
  })

  context('Querying', function () {
    beforeEach(function () {
      cy.visit('https://127.0.0.1:3010/')
    })
    ...
    it('Query DOM elements with matching content', function () {
      cy.get('.query-list')
