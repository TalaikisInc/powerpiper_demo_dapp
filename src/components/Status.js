...
const Status = (props) => {
  ...
  return (
    <div>
      { !props.web3
        ? <div>
          <strong>Warning!</strong> This application will not work without Metamask extension enabled. 
            See download links for <a href='https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn?hl=en' 
            target='_blank' rel='noopener noreferrer'>Chrome</a> and <a href='https://addons.mozilla.org/en-US/firefox/addon/ether-metamask/' 
            target='_blank' rel='noopener noreferrer'>Firefox</a>. Once enabled, refresh the page.
        </div>
        : null
      }
      ...
      { props.account && props.web3.web3Initiated && !props.deployed
        ? <div>
          <strong>Warning!</strong> The selected network is not supported.
        </div>
        : null
      }
    </div>
