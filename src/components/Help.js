...
const Help = () => (
  <Box>
    <Heading>Welcome to PowerPiper!</Heading>
    ...
    <p><strong>1.</strong>
    Download and install <a href="https://metamask.io/" target="_blank" rel="noopener noreferrer">Metamask</a> extension.
    </p>
    ...
    <p><strong>3. </strong>
    Now that you are connected to Rinkeby Test Network 
